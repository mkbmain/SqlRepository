...
{
    public class GetAllIntegrationSync : BaseIntegrationSyncTests
    {
        ...
        [Fact]
        public void Ensure_we_can_GetAll()
        {
        ...
        [Fact]
        public void Ensure_we_can_GetAll_with_where()
        {
            var users = WhatWeShouldHave();
        ...
        [Fact]
        public void Ensure_we_can_GetAll_with_where_and_projection()
        {
            var users = WhatWeShouldHave();
        ...
        [Fact]
        public void Ensure_we_can_GetAll_with_includes()
        {
            var users = WhatWeShouldHave();
        ...
        [InlineData(true)]
        [InlineData(false)]
        public void Ensure_we_test_track(bool track)
        {
            var users = WhatWeShouldHave();
            ...
            var returned = SimpleDbContext.Users.FirstOrDefault(f => f.Id == item.Id);
